...
# monitor-recent-commits.sh - Script to monitor performance for recent commits only
# This is a lighter version for testing the monitoring setup
...
RESULTS_FILE="${RESULTS_DIR}/recent-commit-results-${TIMESTAMP}.csv"
...
# Get list of recent commits (last 5 commits)
echo "Getting list of recent commits..."
COMMITS=($(git log --oneline -5 nrkhadem | awk '{print $1}'))
TOTAL_COMMITS=${#COMMITS[@]}

echo "Found $TOTAL_COMMITS recent commits to monitor"
...
echo ""
echo "=========================================="
echo "RECENT COMMITS MONITORING COMPLETE!"
echo "=========================================="
